...
export default function Hero() {
  return (
    <section className="pt-32 pb-16 px-6">
      ...
      {/* Name & Title */}
      <h1 className="text-xl font-semibold text-white tracking-tight">Rudra</h1>
      <p className="text-sm text-muted-foreground mt-0.5">Developer & Designer</p>

      {/* Bio */}
      <p className="mt-6 text-[15px] leading-relaxed text-muted-foreground max-w-lg">
        A passionate developer & designer working remotely from India. I build for clarity,
